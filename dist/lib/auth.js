...
async function createAuth() {
    ...
    const { prismaAdapter } = await Promise.resolve().then(() => __importStar(require("better-auth/adapters/prisma")));
    return betterAuth({
        database: prismaAdapter(prisma_1.prisma, {
            provider: "sqlite",
        }),
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="text-align: center;">
                            <p style="color: #a0aec0; margin: 0 0 10px; font-size: 14px;">© 2026 Invio. All rights reserved.</p>
