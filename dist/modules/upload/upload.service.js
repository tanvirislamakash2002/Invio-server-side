...
exports.uploadService = exports.uploadToImgbb = void 0;
...
const uploadToImgbb = async (fileBuffer, fileName) => {
    ...
    try {
        ...
        const response = await axios_1.default.post(`https://api.imgbb.com/1/upload?key=${process.env.IMGBB_API_KEY}`, params.toString(), {
            headers: {
...
const uploadAvatar = async (userId, fileBuffer, fileName) => {
    try {
        const imageUrl = await (0, exports.uploadToImgbb)(fileBuffer, fileName);
...
exports.uploadService = {
    uploadToImgbb: exports.uploadToImgbb,
    uploadAvatar
};
